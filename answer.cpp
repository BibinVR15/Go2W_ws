...
int main(int argc, char **argv) {
    ...
    // 🎵 Pick random audio
    std::string chosen = pick_random_audio("/home/verse/unitree_sdk2/example/go2w/zhazha/shortT");
    ...
    std::mt19937 gen(rd());
    std::uniform_real_distribution<double> roll_dist(-0.5, 0.5); // small tilt range
    double roll = 0.0;
