...
int main(int argc, char **argv) {
    ...
    sport_client.Euler(0.0, -0.25, 0.0);  // final "look up" pose
    // keep pose mode ON so robot holds the position
    std::cout << "Robot will stay looking up (pitch = -0.25) after exit." << std::endl;
